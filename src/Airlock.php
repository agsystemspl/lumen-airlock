...
class Airlock
{
     ...
     * @var string
     */
    public static $personalAccessTokenModel = 'AGSystems\\Lumen\\Airlock\\PersonalAccessToken';
     ...
     *
     * @param  \Illuminate\Contracts\Auth\Authenticatable|\AGSystems\Lumen\Airlock\HasApiTokens  $user
